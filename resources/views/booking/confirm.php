<section class="page-hero" style="padding:80px 24px">
  ...
  <p class="hero-sub">Your booking request has been submitted successfully. We'll contact you within 24 hours to confirm.</p>
</section>
...
<section style="max-width:600px;margin:0 auto 80px;padding:0 24px">
  <div style="background:#fff;border-radius:16px;padding:40px;box-shadow:0 4px 24px rgba(0,0,0,0.06);text-align:center">
    ...
    <h2 style="margin:0 0 8px;font-size:24px">Booking Reference</h2>
    ...
    <p style="opacity:0.7;margin:0 0 24px">Please save this reference number for your records.</p>
    ...
    <div style="text-align:left;border-top:1px solid #eee;padding-top:20px;margin-top:20px">
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;font-size:14px">
        ...
        <div><strong>Status:</strong><br><span style="color:var(--primary)">Pending Confirmation</span></div>
